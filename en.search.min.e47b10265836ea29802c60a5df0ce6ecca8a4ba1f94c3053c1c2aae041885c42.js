...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.96898d23a3c72e83cd8e6358e9a705b7f791a6beee440283790a75ea74f6d6cb.js',function(){input.required=false;search();});}
