...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.400a5b890abbbcbc60a2013256434dd68353a6d12d81df07ffab18aee6955313.js',function(){input.required=false;search();});}
